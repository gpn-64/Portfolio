...
Toutes les mises à jour notables du site sont consignées ici, classées par date (la plus récente en haut). Pas de numéros de version — chaque entrée correspond à une date de mise à jour.

## 2026-08-26

### Certifications
- Réorganisées en trois niveaux : Mis en avant, Other, In progress.
- Ajoutées : Business Intelligence (BI) Analyst Professional Certificate (IBM), Mastering Pharmaceutical Marketing (Udemy), Career Essentials in GitHub Professional Certificate (GitHub), Sales Operations (LinkedIn Learning), Vault Primer Certificate (Veeva), Business Analytics Foundations (IIBA), Data Warehousing on Google Cloud Platform (LinkedIn Learning).
- In progress mis à jour : Machine Learning (IBM), Health Economics and Pharmacoeconomics (Udemy).
- Retirées : Yellow Belt Lean Six Sigma (École Centrale Paris), Project Management Level D (IPMA).

### Skills
- Ajout de Streamlit (BI & visualization), Seaborn (Python), Jupyter (Everyday tools).
...
- Ajout d'un `LICENSE` (MIT) et d'un `.gitignore` minimal.
